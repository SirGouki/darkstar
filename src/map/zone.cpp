...
/************************************************************************
*                                                                       *
*  Server for processing entity activity (per server/zone)              *
*  without active areas                                                 *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Server for processing entity activity for active areas               *
*  (per server/zone)                                                    *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Load the zonelines necessary for proper movement between zones.      *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Download Zone settings from the database                             *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Add Pets to the zone (free targid 0x700-0x7FF)                       *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Check for mob parties.  For monsters in a party, there is an         *
*  assistance system (link)                                             *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Transport is leaving, gather the passengers                          *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Remove the character from the zone.  If no one is in the zone and    *
*  the zone server is still running, stop it.                           *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Add the character to the zone.  If the zone server was stopped,      *
*  start it.  Make sure to check the number of characters in the zone,  *
*  as the maxe allowed is 768.                                          *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Spawns transports (ships, chocobos?)                                 *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Get a pointer to any entity in the zone using its TargID             *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Process the TimeOfTheDay changes                                     *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  send packets from an entity to the client?                           *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Server that handles everything in the zone.                          *
*  This includes status effects and mob activity.                       *
*                                                                       *
************************************************************************/
